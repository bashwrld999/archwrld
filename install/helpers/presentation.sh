...
export LOGO_PATH="$ARCHWRLD_PATH/logo.txt"
...
export GUM_CONFIRM_SELECTED_BACKGROUND="203"   # Green background for selected
...
clear_logo() {
  ...
  gum style --foreground 203 --padding "1 0 0 $PADDING_LEFT" "$(<"$LOGO_PATH")"
}
